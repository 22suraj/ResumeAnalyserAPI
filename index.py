...
def getpdfData():
    ...
    return json.dumps({"quan_list": "{}".format(quan_list), "common_words": "{}".format(common_words), "grammarchk_dict": "{}".format(grammarchk_dict), "misspelled_words": "{}".format(misspelled_words)})
